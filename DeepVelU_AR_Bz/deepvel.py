...
class deepvel(object):
	...
	def validation_generator(self):
		...
		if(self.same_as_training == 0):
			self.bz1_min = np.amin(self.observations[:, self.border_x1:self.border_x1 + self.nx, self.border_y1:self.border_y1 + self.ny])
			self.bz1_max = np.amax(self.observations[:, self.border_x1:self.border_x1 + self.nx, self.border_y1:self.border_y1 + self.ny])
