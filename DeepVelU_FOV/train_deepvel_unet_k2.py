	...
	def validation_generator(self):
		...
		while 1:
			for i in range(self.batchs_per_epoch_validation):
				...
				input_validation = np.zeros((self.n_validation, self.nx, self.ny, self.n_times))
				output_validation = np.zeros((self.n_validation, self.nx, self.ny, self.n_components))
